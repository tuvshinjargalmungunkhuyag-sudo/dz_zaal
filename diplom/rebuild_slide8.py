"""
v3_editable_v2.pptx -> v3_editable_v3.pptx
8-р slide дээр "Бүлэг 2 — Хөгжүүлэлт" гэсэн section cover-ыг native
PowerPoint shape-аар зурна. Бүх зүйл editable.
"""
...
SRC = r"C:\Users\user\Documents\dz_zaal\diplom\v3_editable_v2.pptx"
DST = r"C:\Users\user\Documents\dz_zaal\diplom\v3_editable_v3.pptx"
...
slide = prs.slides[7]    # 8-р slide

# Title placeholder болон Content placeholder-ыг устгаж шинээр зурна
...
add_text(slide, TXT_X, Emu(1_200_000), TXT_W, Emu(700_000),
         "БҮЛЭГ 2", size=22, bold=True, color=ACCENT2,
         align=PP_ALIGN.LEFT)
...
# --- 3) 4 сэдэв (badge) ---------------------------------------------------
topics = [
    ("Шаардлага",   "Use Case · Activity",          ACCENT),
    ("Загварчлал",  "Sequence · UML",                ACCENT2),
    ("UI / UX",     "Flutter дэлгэцүүд",             ACCENT3),
    ("Өгөгдөл",     "Firestore схем",                ACCENT4),
]
...
for i, (title, sub, color) in enumerate(topics):
    ...
    # Үндсэн карт (цайвар background, өнгөт border)
