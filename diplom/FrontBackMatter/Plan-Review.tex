...
\begin{titlepage}
	...
	\begin{tabularx}{1\textwidth}{| >{\hsize=0.2\hsize}X
		...
		1 & \parbox[l]{9cm}{
			1.1 Сэдэв сонгосон үндэслэл, асуудлын тодорхойлолт \\
			1.2 Зорилго, зорилт, шинэлэг тал \\
			1.3 Судлагдсан байдал, хамрах хүрээ, ач холбогдол } & 20\% & III.13 \\
		& & & \\ \hline
		\multicolumn{4}{|l|}{\parbox[l]{13cm}{Бүлэг №1. Онол ба технологийн судалгаа}} \\ \hline
		\multirow{3}{*}{} &\multirow{3}{*}{} & \multirow{3}{*}{} & \multirow{3}{*}{} \\
		2 & \parbox[l]{9cm}{
			1.1 Мобайл технологи (Flutter, Dart, Firebase, AI чатбот) \\
			1.2 Бэкэнд технологи (Node.js, Express, REST API) \\
			1.3 Үүлэн технологи (Docker, AWS EC2/ECR, GitHub Actions) } & 40\% & IV.10 \\  & & & \\ \hline
		...
		3 & \parbox[l]{9cm}{
			...
			2.4 Өгөгдлийн сан (Firestore collection-уудын загвар) } & 40\% & V.22 \\ & & & \\ \hline
...
\begin{titlepage}
	...
	\begin{center}
		...
		\begin{tabularx}{1\textwidth}{| >{\hsize=0.1\hsize}Z
			...
			2 & {Бүлэг 1: Онол ба технологийн судалгаа хийсэн} & 2026-04-10 &  \\ \hline
			3 & {Бүлэг 2: Загварчлал, хөгжүүлэлт хийсэн (Flutter, Node.js)} & 2026-05-15 &  \\ \hline
